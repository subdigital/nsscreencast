...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func setupLogging() {
        ...
        file.logFileURL = URL(fileURLWithPath: docsDir).appendingPathComponent("app.log")
        log.addDestination(file)
        
        let httpFile = FileDestination()
        httpFile.minLevel = .error
        httpFile.logFileURL = URL(fileURLWithPath: docsDir).appendingPathComponent("http.log")
        ...
        let cloud = SBPlatformDestination(appID: "nXOONe", appSecret: "ywikl7hsnm1gthSsukhpjRgacMzwxpD5", encryptionKey: "biw1iffvs8cKy1uwRuuvjkrqhaamup5O")
