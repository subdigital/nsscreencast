            ...
            if ([self successfulStatusCode:urlResponse.statusCode]) {
                ...
                dispatch_async(dispatch_get_main_queue(), ^{
                    if (followerData) {
                        ...
                        NSArray *followers = [followerData[@"users"] fkb_map:^TwitterFollower *(NSDictionary *followerDictionary) {
                            return [[TwitterFollower alloc] initWithDictionary:followerDictionary];
                        }];
