...
- (void)preloadSounds {
    self.giggleSounds = @[
                          ...
                          [SKAction playSoundFileNamed:@"laugh2.caf" waitForCompletion:YES],
                          [SKAction playSoundFileNamed:@"laugh3.caf" waitForCompletion:YES],
                          [SKAction playSoundFileNamed:@"laugh4.caf" waitForCompletion:YES],
                          [SKAction playSoundFileNamed:@"laugh5.caf" waitForCompletion:YES],
                          [SKAction playSoundFileNamed:@"laugh6.caf" waitForCompletion:YES]
                          ];
}
...
- (SKNode *)gigglerNode {
    ...
    } name:@"ThrottleGiggleSound" limit:0.6];
