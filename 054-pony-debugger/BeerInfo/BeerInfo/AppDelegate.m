...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [[PDDebugger defaultInstance] addManagedObjectContext:
     [[[BeerInfoDataModel sharedDataModel] objectStore] mainQueueManagedObjectContext] withName:@"Main Context"
     ];
...
- (void)setupCoreData {
    [[BeerInfoDataModel sharedDataModel] setup];
}
